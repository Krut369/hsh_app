...
@RoutePage()
class AttendanceMainScreen extends GetView<LeaderAttendanceController> {
                            ...
                            child: Row(
                              children: [
                                _buildTab(controller,
                                    AttendanceEventType.breakfast, 'Breakfast'),
                                _buildTab(controller, AttendanceEventType.lunch,
                                    'Lunch'),
                                _buildTab(controller,
                                    AttendanceEventType.dinner, 'Dinner'),
                              ],
                            ),
                          ),
                          const SizedBox(height: 16),
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: AttendanceEventType.values
                              .where(
                                  (type) => type != AttendanceEventType.other)
                              .map((type) {
                            return Padding(
                              ...
                              child: EventTypeChip(
                                ...
                                isSelected:
                                    controller.selectedEvent.value == type,
  ...
  Widget _buildTab(LeaderAttendanceController controller,
      AttendanceEventType type, String label) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: TextStyle(
            color:
                isSelected ? const Color(0xFF1D3557) : const Color(0xFF94A3B8),
