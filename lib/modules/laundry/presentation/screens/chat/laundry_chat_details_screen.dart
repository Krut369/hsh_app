...
class LaundryChatDetailsScreen extends StatefulWidget {
  final String? conversationId;

  const LaundryChatDetailsScreen({super.key, this.conversationId});

  @override
  State<LaundryChatDetailsScreen> createState() =>
      _LaundryChatDetailsScreenState();
}

class _LaundryChatDetailsScreenState extends State<LaundryChatDetailsScreen> {
  ...
  void initState() {
    ...
    // Listen to changes to scroll to bottom when new message arrives
